...
import FireExtinguisher from '../../assets/svg/FireExtinguisher'
        ...
        {offers
          ? offers.map((item, index) => (
              <div className="flexNullCenter" style={{ margin: "15px 0" }} key={index}>
                ...
                <p className="font12 extraBold" 
                  style={{width: '100%', textAlign: 'left', alignItems: 'start', justifyContent: 'start'}}>
                    {item.name}
                </p>
              </div>
            ))
